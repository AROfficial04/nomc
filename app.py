...
def process_data():
    try:
        ...
        wfm_analysis = analyze_column(df_wfm, ["Region Name", "New Meter Connection Type / Phase Type","Meter DT/WC"])
        ...
        never_comm_analysis = analyze_column(never_comm_data, ["Region Name", "New Meter Connection Type / Phase Type","Meter Communication Type"])
        ...
        def generate_pivot_summary(df_wfm, df_hes, non_comm_data, never_comm_data, unmapped_data):
            ...
            def wfm_summary():
                return pd.crosstab(
                    [df_wfm['Region Name'], df_wfm['Meter DT/WC']],
                    df_wfm['New Meter Connection Type / Phase Type'],
